...
// Helper — detects "Today's Special" category by name
const isSpecialCat = (name: string) =>
  name.toLowerCase().includes("today") ||
...
export default function MenuPage() {
  ...
  const [todaySpecials, setTodaySpecials] = useState<FoodItem[]>([]);  // ← NEW
  ...
  // suppress unused-var warning for sessionKey if not used elsewhere
  const _sessionKey = useMemo(() =>
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // ── Split out Today's Special from regular categories ──
  ...
  // filteredItems — only from normal categories (specials excluded)
  ...
  // Strip — all items with images from normal categories only
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hdr {
          background: linear-gradient(160deg, #2A0606 0%, #4A1010 35%, #5D1616 65%, #3A0B0B 100%);
        ...
        @media(min-width:768px) {
          .hi { flex-direction: row; align-items: center; padding: 14px 28px; gap: 16px; }
        ...
        .nbtn {
          ...
          background: rgba(255,255,255,.06); border: 1px solid rgba(200,169,81,.28);
          color: rgba(255,248,225,.9); font-family: var(--sans); font-size: 13px; font-weight: 600;
          white-space: nowrap; cursor: pointer; backdrop-filter: blur(8px);
        ...
        .srch {
          ...
          background: rgba(255,255,255,.07); border: 1px solid rgba(200,169,81,.22);
        ...
        .spl-card {
          ...
          background: var(--card); border: 1.5px solid rgba(200,169,81,.3);
          display: flex; gap: 0;
          box-shadow: 0 4px 24px rgba(93,22,22,.1), 0 1px 4px rgba(93,22,22,.06);
          -webkit-tap-highlight-color: transparent;
          transition: transform .4s cubic-bezier(.23,1,.32,1), box-shadow .4s, border-color .4s;
          animation: splIn .7s cubic-bezier(.23,1,.32,1) both;
        }
        ...
        .spl-card::before {
          ...
          background: linear-gradient(135deg, rgba(200,169,81,.06) 0%, transparent 60%);
          pointer-events: none;
        }
        ...
        .spl-card::after {
          ...
          background: linear-gradient(90deg, transparent, var(--g) 30%, var(--gl) 50%, var(--g) 70%, transparent);
        ...
        .spl-img-wrap img { transition: transform .6s cubic-bezier(.23,1,.32,1); }
        ...
        .spl-badge {
          ...
          background: linear-gradient(135deg, var(--g), var(--gd)); color: var(--ink);
        ...
        .spl-desc {
          font-family: var(--sans); font-size: 12px; color: rgba(93,22,22,.5); line-height: 1.5;
        ...
        .spl-abtn {
          ...
          background: linear-gradient(135deg, #5D1616 0%, #3D0D0D 100%);
          color: var(--g); font-family: var(--sans); font-size: 12px; font-weight: 700;
          letter-spacing: .08em; border: 1px solid rgba(200,169,81,.35);
          -webkit-tap-highlight-color: transparent; position: relative; overflow: hidden;
          transition: transform .3s cubic-bezier(.34,1.56,.64,1), box-shadow .3s;
          box-shadow: 0 4px 16px rgba(45,10,15,.25);
        }
        ...
        .spl-qb {
          ...
          color: var(--g); font-size: 18px; font-weight: 700; border: none; cursor: pointer;
          -webkit-tap-highlight-color: transparent;
        ...
        .sc {
          ...
          border-radius: 16px; border: 1.5px solid rgba(200,169,81,.2);
          box-shadow: 0 4px 14px rgba(45,10,15,.1);
        ...
        .sc img { transition: transform .5s cubic-bezier(.23,1,.32,1); }
        ...
        .pill {
          flex-shrink: 0; padding: 8px 22px; border-radius: 100px; cursor: pointer;
          border: 1.5px solid rgba(93,22,22,.12); background: var(--card); color: var(--c);
          font-family: var(--sans); font-size: 13px; font-weight: 500; white-space: nowrap;
          -webkit-tap-highlight-color: transparent;
          box-shadow: 0 2px 8px rgba(93,22,22,.05);
        ...
        .fc {
          background: var(--card); border: 1.5px solid rgba(200,169,81,.15);
          border-radius: 18px; overflow: hidden; display: flex; flex-direction: column;
          opacity: 0; transform: translateY(24px) scale(.97);
          box-shadow: 0 2px 12px rgba(93,22,22,.06);
          transition: opacity .5s cubic-bezier(.23,1,.32,1), transform .5s cubic-bezier(.23,1,.32,1), box-shadow .4s, border-color .4s;
        }
        ...
        .fc-img img { transition: transform .6s cubic-bezier(.23,1,.32,1); }
        ...
        .abtn {
          padding: 7px 17px; border-radius: 9px; border: none; cursor: pointer;
          ...
          transition: transform .3s cubic-bezier(.34,1.56,.64,1), box-shadow .3s;
          box-shadow: 0 3px 10px rgba(200,169,81,.3);
        }
        ...
        .cta-wrap {
          ...
          animation: ctaUp .5s cubic-bezier(.34,1.56,.64,1);
        }
        ...
        .ctabtn {
          ...
          background: linear-gradient(135deg, #6E1A1A 0%, #3A0808 50%, #6E1A1A 100%);
          background-size: 200% 100%;
          border: 1.5px solid rgba(200,169,81,.45);
          box-shadow: 0 8px 32px rgba(45,10,15,.4), inset 0 1px 0 rgba(200,169,81,.15);
          -webkit-tap-highlight-color: transparent;
        ...
        .toast {
          ...
          background: rgba(24,4,8,.97); border: 1px solid rgba(200,169,81,.38);
          color: var(--g); font-family: var(--sans); font-size: 13px; font-weight: 500;
          padding: 10px 24px; border-radius: 12px; white-space: nowrap; z-index: 60;
      ...
      <div className="pg" style={{ paddingBottom: totalQty > 0 ? 92 : 28 }}>
        ...
        <div className="bd">
          ...
          {!loading && !error && (<>
            ...
            {/* ══ TODAY'S SPECIAL — only renders if backend has the category ══ */}
            {todaySpecials.length > 0 && (
              <div ref={splRef} className={`spl-section${splVisible ? " vis" : ""}`}>
            ...
            {/* ══ SCROLLING HIGHLIGHTS — normal categories only ══ */}
            {allItems.length > 0 && (
